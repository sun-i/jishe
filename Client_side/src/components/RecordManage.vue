        ...
        <el-container> 
            ...
            <el-main class="main">
                ...
                <el-table
                    ...
                    <template slot-scope="scope">
                        <el-button round size="small" type="text" @click="gotoDetail(scope.row.id)">查看详情</el-button>
                        <el-button round size="small" type="text" @click="gotoRecord(scope.row.id)">撰写病历</el-button>
                    </template>
                    </el-table-column>
                </el-table>
            </el-main>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            let that = this
            let url = '/patient/uncheck/' + that.patientInfo.id
